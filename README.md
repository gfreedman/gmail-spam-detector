...
- ✅ **100% detection** on 41/41 real spam (.eml files)
...
│   ├── spam_examples/           # Real spam .eml files (41)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.16.3`, etc.)
