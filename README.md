...
- ✅ **0% false positives** on 13/13 legitimate emails
...
│   └── ham_examples/            # Legitimate .eml files (13)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.17.7`, etc.)
