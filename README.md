...
- ✅ **100% detection** on 36/36 real spam (.eml files)
...
│   ├── spam_examples/           # Real spam .eml files (36)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.15.2`, etc.)
