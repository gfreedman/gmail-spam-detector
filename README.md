...
- ✅ **0% false positives** on 12/12 legitimate emails
...
│   └── ham_examples/            # Legitimate .eml files (12)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.17.4`, etc.)
