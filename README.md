...
- ✅ **100% detection** on 40/40 real spam (.eml files)
...
│   ├── spam_examples/           # Real spam .eml files (40)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.16.2`, etc.)
