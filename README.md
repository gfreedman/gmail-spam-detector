...
- ✅ **100% detection** on 42/42 real spam (.eml files)
...
│   ├── spam_examples/           # Real spam .eml files (42)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.17.0`, etc.)
