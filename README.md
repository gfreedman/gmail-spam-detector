...
- ✅ **100% detection** on 35/35 real spam (.eml files)
...
│   ├── spam_examples/           # Real spam .eml files (35)
...
3. **Tag** — Auto-creates a git tag when the commit message contains a version (`v6.15.0`, etc.)
